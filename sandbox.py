...
if locations:
    ...
    bccmail = orchestrator_connection.get_constant("jadt").value
    SendEmail(to_address = bccmail, subject="Ingen stop i dag",  body="Da der hverken er fundet stop i Vejman eller Mobility Workspace er der ikke nogle ruter i dag", bcc = bccmail)
